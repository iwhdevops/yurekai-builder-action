...
const create_builder_app_1 = require("@iwhdevops/create-builder-app");
const gitUserName = "BuilderYurekai Bot";
const gitUserEmail = "ops+git@yureak.com";
class PlasmicAction {
    constructor(args) {
        this.args = args;
        this.opts = {
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (0, create_builder_app_1.setMetadata)({
                source: "plasmic-action",
            });
            const relTmpDir = "tmp-cpa";
            yield (0, create_builder_app_1.create)({
    ...
    sync() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, exec_1.exec)(`${pm.add} @plasmicapp/cli`, this.opts);
            yield (0, exec_1.exec)(`${pm.cmd} plasmic sync --projects '${this.args.projectId}:${this.args.projectApiToken}' --yes`, this.opts);
